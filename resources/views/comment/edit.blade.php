    ...
    <x-sidebar>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="space-y-4">
                ...
                <h3 class="text-2xl font-semibold">Edit Comment Thread</h3>
                ...
                <div class="flex space-x-3 border-b pb-4 border-gray-200 mt-4">
                    ...
                    <div class="space-y-1">
                        <h3 class="font-semibold">{{ $comment->thread->user->name }} <span
                                class="text-sm font-normal text-gray-400">{{ '@' . $comment->thread->user->username }}</span>
                        </h3>
                        <p class="font-normal text-gray-700">{{ $comment->thread->content }}</p>
                        <p class="text-sm font-normal text-gray-400">{{ $comment->thread->created_at->diffForHumans() }}
                        </p>
                        ...
                        <div class="flex space-x-4 mt-2">
                            <form action="" method="POST" class="inline">
                                ...
                                <button type="submit" class="flex items-center space-x-1 focus:outline-none">
                                    ...
                                    <span class="text-sm">{{ $comment->thread->likes->count() }} Like</span>
                                </button>
                            </form>
                            ...
                            <div class="flex items-center space-x-1 focus:outline-none">
                                ...
                                <span class="text-sm">{{ $comment->thread->comments->count() }}
                                    Comment</span>
                            </div>
                ...
                <form action="{{ route('comment.store') }}" method="post"
                    ...
                    <div class="relative w-full">
                        <input type="text" name="content" id="content"
                            ...
                            placeholder="Post your reply" value="{{ $comment->content }}" required />
                    </div>
                    <button type="submit"
