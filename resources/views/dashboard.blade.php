    ...
    <x-sidebar>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="space-y-4">
                ...
                {{-- Form untuk create Thread --}}
                <form action="" class="flex items-center mx-auto px-2 py-4 border-b border-gray-200">
                ...
                @foreach ($threads as $thread)
                    <div class="mx-4 flex space-x-2 border-b pb-4 border-gray-200">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-sm font-normal text-gray-400">{{ $thread->created_at->diffForHumans() }}</p>
                            ...
                            <div class="flex space-x-4 mt-2">
                                ...
                                <a href=""
                                    ...
                                    <span class="text-sm">{{ $thread->comments->count() }} Comment</span>
                                </a>
                            </div>
                    ...
                    @foreach ($trendings as $word => $count)
                        <div class="">
                            ...
                            <h3 class="text-lg font-medium">
                                <a href="#" class="hover:underline transition">{{ $word }}</a>
                            </h3>
